...
const Navbar: React.FC<NavbarProps> = ({ user, walletBalance }) => {
  ...
  return (
    <nav className="bg-background text-primary py-4 px-6 flex items-center justify-between relative z-50">
      {/* Logo Section */}
      ...
      {/* Mobile Navigation */}
      <motion.div
        className="absolute top-0 left-0 w-3/4 h-full bg-background text-white flex flex-col space-y-6 px-6 py-8 md:hidden z-40"
        initial="closed"
